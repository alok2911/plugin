...
add_action( 'wp_enqueue_scripts', 'wpdocs_theme_name_scripts' );
 ...
 function registration_form( $username, $password, $email, $first_name, $last_name, $contact, $company ) {
    echo '
    <style>
    div {
        margin-bottom:2px;
...
function registration_validation( $username, $password, $email, $first_name, $last_name, $contact, $company)  {
    global $reg_errors;
...
function complete_registration() {
    global $reg_errors, $username, $password, $email, $first_name, $last_name, $contact, $company; 
...
function custom_registration_function() {
    if ( isset($_POST['submit'] ) ) {
        ...
        global $username, $password, $email, $first_name, $last_name, $contact, $company;
